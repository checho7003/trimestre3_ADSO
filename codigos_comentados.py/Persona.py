class Persona: #Esta linea define una clase llamada Persona.
    def __init__(self,nombre,documento): #Esta línea define el método __init__, que es el constructor de la clase Persona. El constructor se llama automáticamente cuando se crea una instancia de la clase. El constructor toma como parámetros el objeto self (que se refiere a la propia instancia) y el argumento nombre.
    ...
    def getdocumento(self): #Esta line define el metodo getdocumento 
...
ob=Persona('Ana', "la magia") #Esta línea crea una nueva instancia de la clase Persona y la asigna a la variable ob. El constructor de la clase se llama automáticamente con el argumento 'Ana'.
